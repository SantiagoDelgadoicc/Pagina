...
window.onload = () =>{
    ...
    //muestro los diferentes comentarios guardados en localstorage
       for(let i = 0; i < libros[id].comentarios.length; i++){
            ...
            let botonbasura=``;
            if(nombre != "el rincon"){
                botonbasura += `<div class="col-1" style = "display:flex; justify-content: end ; border: 1px solid black">
             ...
             contenido3.innerHTML = `<div class="row mt-3" style = "border: 1px solid black">
                                        <div class="col-11" style = "border: 1px solid black">
